...
export function PluginDetail({ plugin }: PluginDetailProps): React.ReactElement {
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-12">
        ...
        <div className="relative">
          <div className={`absolute -inset-1 bg-gradient-to-r ${categoryColor.bg} rounded-3xl opacity-50 blur-xl`} />
