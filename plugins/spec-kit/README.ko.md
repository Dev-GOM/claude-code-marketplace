...
### v2.3.2 (2025-10-21)
- **수정**: 모호한 지시로 인한 AskUserQuestion 도구 미호출 문제 해결
- **추가**: 명시적 도구 사용 가이드라인 및 모든 제약사항 (2-4 옵션, 12자 헤더, 1-5단어 레이블)
- **추가**: 모든 사용자 상호작용 지점에 MUST 지시 추가
- **수정**: Step 4.2 최소 옵션 요구사항 ("요구사항 추가" 옵션 추가)
- **개선**: 모든 섹션에 체크마크로 제약사항 검증 표시

### v2.3.1 (2025-10-21)
- **개선**: tasks 커맨드의 rigid AskUserQuestion JSON 구조 제거
- **향상**: Claude가 컨텍스트에 따라 자율적으로 질문 결정
- **UX 개선**: 더 유연하고 자연스러운 대화 흐름
