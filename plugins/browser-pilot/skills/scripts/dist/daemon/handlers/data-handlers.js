 ...
 */
async function handleContent(context, _params) {
    return actions.getContent(context.browser);
}
/**
 * Handle find command (find element)
 */
async function handleFind(context, params) {
    const selector = params.selector;
 ...
 */
async function handleEval(context, params) {
