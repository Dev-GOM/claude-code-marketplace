...
function registerQueryCommands(program) {
    ...
    program
        ...
        try {
            ...
            if (options.verbose)
                params.verbose = true;
            // Execute query
            const response = await (0, daemon_helper_1.executeViaDaemon)('query-map', params);
            if (response.success) {
    ...
    program
        ...
        .action(async () => {
        try {
            const response = await (0, daemon_helper_1.executeViaDaemon)('get-map-status', {});
            if (response.success) {
    ...
    program
        ...
        try {
            ...
            const response = await (0, daemon_helper_1.executeViaDaemon)('generate-map', { force: true });
            if (response.success) {
