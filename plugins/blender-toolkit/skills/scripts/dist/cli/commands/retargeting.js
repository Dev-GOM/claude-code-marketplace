...
exports.registerRetargetingCommands = registerRetargetingCommands;
const index_1 = require("../../index");
const logger_1 = require("../../utils/logger");
function registerRetargetingCommands(program) {
    // Retarget Animation
    program
        .command('retarget')
        ...
        try {
            const workflow = new index_1.AnimationRetargetingWorkflow();
            ...
            logger_1.logger.error('Retargeting failed:', error);
