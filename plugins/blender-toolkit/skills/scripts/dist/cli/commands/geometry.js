...
exports.registerGeometryCommands = registerGeometryCommands;
...
function registerGeometryCommands(program) {
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create cube:', error);
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create sphere:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create cylinder:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create plane:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create cone:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to create torus:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to subdivide mesh:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            if (vertices.length <= 10) {
                ...
                vertices.forEach((v) => {
                    console.log(`   Vertex ${v.index}: [${v.co.map((n) => n.toFixed(3)).join(', ')}]`);
                });
            }
            else {
            ...
            logger_1.logger.error('Failed to get vertices:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            console.log(`   Vertex ${result.vertex_index}: [${result.position.map((n) => n.toFixed(3)).join(', ')}]`);
            await client.disconnect();
        }
        catch (error) {
            logger_1.logger.error('Failed to move vertex:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
