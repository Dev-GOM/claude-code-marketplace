...
exports.registerModifierCommands = registerModifierCommands;
const client_1 = require("../../blender/client");
const logger_1 = require("../../utils/logger");
const client = new client_1.BlenderClient();
function registerModifierCommands(program) {
    // Add Modifier
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to add modifier:', error);
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to apply modifier:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to list modifiers:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to remove modifier:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to toggle modifier:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            if (options.segments !== undefined)
                properties.segments = options.segments;
            if (options.count !== undefined)
                properties.count = options.count;
            ...
            logger_1.logger.error('Failed to modify modifier properties:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to get modifier info:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
    ...
    program
        ...
        try {
            ...
            logger_1.logger.error('Failed to reorder modifier:', error);
            console.error('❌ Error:', error instanceof Error ? error.message : error);
            process.exit(1);
        }
    });
